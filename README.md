...
(54) 24-05-13 : 팀 조회 화면 추가 (사용자 입장)

(55) 24-05-13 : 권한별 메뉴 - 랜딩 페이지 추가 -> 초기 로그인시, 해당 권한은 해당 랜딩 페이지로 리디렉션된다.

(56) 24-05-14
1. 첨부파일 최대 첨부개수 및 확장자 제한
...
(59) 24-05-13 : 사용자 프로필 이미지 추가 -> 프로필 이미지 수정 가증 로직 구현

(60) 24-05-16
- 댓글 부분 handlebars 사용해서 뺴기
- 댓글 등록/수정/삭제 로직구현


(61) 24-05-16 : 게시판 유형 등록/수정/삭제 로직 구현

(62) 24-05-17 : 게시글 리스트 조회

(63) 24-05-17 :  게시글 수정/삭제 로직
