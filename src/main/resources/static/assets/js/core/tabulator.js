    ...
    */
    _initOptions(data){
        ...
        if(this._pagination) {
            ...
            option['locale'] = "ko-kr"
            option['langs'] = this._langs()
            option['paginationCounter'] = function(pageSize, currentRow, currentPage, totalRows, totalPages) {
                return `<span>검색결과 <b>${totalRows}</b>건 중 <b>${pageSize}</b>건</span>`
            }
        }
